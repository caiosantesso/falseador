...
describe('entreUmE()', () => {
  ...
  test('erro para limite menor ou igual a 1', () => {
    expect(() => falseador.número.entreUmE(1)).toThrowError();
  });

  test('erro para limite menor ou igual a 2 (exclusivo)', () => {
    expect(() => falseador.número.entreUmE(2, false)).toThrowError();
  });
});
...
describe('entreZeroE()', () => {
  ...
  test('erro para limite menor ou igual a 0', () => {
    expect(() => falseador.número.entreZeroE(0)).toThrowError();
  });

  test('erro para limite menor ou igual a 1 (exclusivo)', () => {
    expect(() => falseador.número.entreZeroE(1, false)).toThrowError();
  });
});
...
describe('exclusivoEntreUmE()', () => {
  ...
  test('erro para limite menor ou igual a 2 (exclusivo)', () => {
    expect(() => falseador.número.exclusivoEntreUmE(2)).toThrowError();
  });
});
...
describe('exclusivoEntreZeroE()', () => {
  ...
  test('erro para limite menor ou igual a 1 (exclusivo)', () => {
    expect(() => falseador.número.exclusivoEntreZeroE(1)).toThrowError();
  });
});
