...
export class Pessoa {
  ...
  private iniciais(nomeCompleto: string) {
    return this.#nome
  ...
  private primeiroMaisIniciais(nomeCompleto: string) {
    return this.#nome
      .abreviado(nomeCompleto)
      .split(' ')
  ...
  private iniciaisMaisÚltimo(nomeCompleto: string) {
    return this.#nome
      .abreviado(nomeCompleto)
      .split(' ')
  ...
  private abreviado(nomeCompleto: string) {
    return this.#nome
      .abreviado(nomeCompleto)
      .replaceAll(/\. (?=[A-Z]\.)/g, '')
      .replaceAll(/\./g, '');
  ...
  private primeiroEÚltimo(nomeCompleto: string) {
